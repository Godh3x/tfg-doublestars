...
capítulo de \nameref{cap7} y \nameref{cap2}. Como mis compañeros no saben
utilizar \LaTeX{} también me he encargado de incluir sus aportaciones a este
documento.
...
doble. Así mismo, de la memoria me encargué de redactar el capítulo \ref{cap6} y
colaboré en la redacción de la sección \ref{cap4:sec:params}.
...
daba el valor de los atributos que separan en el hiperplano las muestras de
