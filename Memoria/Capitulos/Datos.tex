...
\begin{enumerate}
  ...
  \item Desactiva el retículo, es un marcador que se situa sobre la coordenada
    introducida.
  ...
  \item Utiliza la herramienta RGB sobre las vistas 1 y 2, las imágenes recien
    descargadas.
...
parametros del modelo generado. Por último, el test set es un conjunto de datos,
