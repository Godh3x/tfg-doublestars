...
imagenes astronómicas con las que trabajar, así como datos de estrellas
...
imagenes que conforman el espectro positivo del dataset. Para poder formarlo
...
generar un módelo que, a priori, funciona. El problema es que, si solo se usa un
...
especificamente los datos del set de validación. Este último motivo es el que
...
funciona, si por el contrario no son los esperados es necesario reentrenar el
modelo desde cero, no vale con modificar los parametros.
