...
En los capítulos \ref{cap3} y \ref{cap4} se describen diferentes procesos por los
...
Sin embargo, creemos que esta tarea puede simplificarse mediante la creación
de un controlador que se encargue de lanzar las etapas en diferentes hilos, para
que sigan ejecutándose a la vez, y pararlas cuando el usuario lo requiera.
...
hora de lanzar el hilo es necesario saber a que función llamar para lo cual nos
encontramos con dos opciones: llamar siempre a una función con un nombre
