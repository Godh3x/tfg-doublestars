...
En los capitulos \ref{cap3} y \ref{cap4} se describe diferentes procesos por los
que una fotografía ha de pasar para poder detectar sistemas de estrellas dobles,
cada una de estas etapas viene definida por un numero arbitrario de entradas y
salidas y un evento que al abortar la ejecución permita al programa salir de
forma segura.

\medskip

Cada etapa por tanto puede ser configurada por sepado y lanzada puesto que para
conectarlas solo es necesario que la salida de una etapa sea la entrada de la
siguiente, de esta forma todas las etapas pueden trabajar de forma simultanea.
